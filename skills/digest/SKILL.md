...
Both sub-agents are spawned as **`general-purpose`** agents with **`model: haiku`**. Their instructions are loaded at runtime by reading the skill file and embedding it into the prompt.
